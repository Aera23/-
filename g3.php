...
{setcookie("o", time(), time()+3600);setcookie("crc", crc32(base64_encode($_SERVER['REMOTE_ADDR'].time())), time()+3600);
...
$r = time()%10;
$old = glob('*.eep');foreach($old as $eep){if(80+filectime($eep)<time()){unlink($eep);}}
