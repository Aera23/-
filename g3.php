...
function g($l){
if(!isset($_REQUEST['next'])){echo"<meta http-equiv='refresh' content='0.03 28.php'/>";exit($l);}
...
elseif($_REQUEST['o']<time() && crc32(base64_encode($_SERVER['HTTP_USER_AGENT']."127.0.0.1".$_COOKIE['o']))==$_COOKIE['crc']){
 return "1";}
 elseif(isset($_GET['apikey'])&&file_exists("Public/temp/hostname")&&$_GET['apikey']=="nrzknf.txt"){return "1";}
else{return "2";}}
...
if(isset($_COOKIE['o'])&&abs($_COOKIE['o']-time())<34000&&crc32(base64_encode("127.0.0.1".$_COOKIE['o']))==$_COOKIE['crc']){g($l);}
