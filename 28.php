...
if(($time)>time()&&crc32(strrev("127.0.0.1"))==$addr){return "1";}
else{return"2";}}
...
$e.='<mark class="ref" style="background:#000;color:#080">'.(time()%10).'</mark>';
